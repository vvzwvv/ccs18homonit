...
def appTouch(evt) {
    sendLocationEvent(name:"acceleration", value:"active", descriptionText: "acceleration active", deviceId: "63030cd2-26ca-4d72-b405-090f346be8cc", source: "DEVICE", isStateChange:true)
}
