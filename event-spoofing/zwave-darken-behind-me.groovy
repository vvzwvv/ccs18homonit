...
def appTouch(evt) {
    sendLocationEvent(name:"motion", value:"inactive", descriptionText: "motion inactive", deviceId: "af220d9d-0a0f-4548-be0a-e46114ec27f9", source: "DEVICE", isStateChange:true)
}
