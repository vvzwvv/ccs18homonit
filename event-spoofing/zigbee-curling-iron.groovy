...
def appTouch(evt) {
	sendLocationEvent(name:"motion", value:"active", descriptionText: "motion active", deviceId: "e6e93998-ab65-43f7-a0f4-7bf480089244", source: "DEVICE", isStateChange:true)
}
