...
def appTouch(evt) {
    sendLocationEvent(name:"contact", value:"closed", descriptionText: "contact closed", deviceId: "91378bc7-2f9e-48de-9ba5-7717ea1faaee", source: "DEVICE", isStateChange:true)
}
