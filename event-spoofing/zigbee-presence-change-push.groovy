...
def appTouch(evt) {
    sendLocationEvent(name:"presence", value:"present", descriptionText: "presence present", deviceId: "80a18a35-20fb-4186-aba3-4caa51697e65", source: "DEVICE", isStateChange:true)
}
