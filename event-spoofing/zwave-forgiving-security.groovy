...
def appTouch(evt) {
  sendLocationEvent(name:"motion", value:"active", descriptionText: "motion active", deviceId: "af220d9d-0a0f-4548-be0a-e46114ec27f9", source: "DEVICE", isStateChange:true)
  sendLocationEvent(name:"contact", value:"open", descriptionText: "contact open", deviceId: "91378bc7-2f9e-48de-9ba5-7717ea1faaee", source: "DEVICE", isStateChange:true)
}
